...
class UnityServer:
    ...
    def start(cls, client_init_module_path):
        ...
        if not cls._rpyc_server_connection:
            ...
            cls._rpyc_server_connection = polling_server.PollingServer(polling_server.PollingSlaveService, port=polling_port, protocol_config = config)
        ...
        with cls._client_connection_lock:
            ...
            if not cls._rpyc_client_connection:
                ...
                try:
                    ...
                    cls._rpyc_client_connection = rpyc.connect('localhost', client_port,config = config)
                    log(' connected')
                except:
                    pass
